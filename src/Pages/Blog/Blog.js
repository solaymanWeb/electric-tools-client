    ...
    return (
        <section className='mt-12'>
            ...
            <div class=" bg-base-200 mt-5 text-left p-8 rounded-b-box">
                <div>
                <h1 class="text-2xl  font-bold">2. what are the different way to manage state in a react application ?</h1>
                <div className='py-2  '>
            ...
            <div class=" bg-base-200 mt-5 text-left p-8 rounded-b-box">
                <div>
                <h1 class="text-2xl  font-bold">3. How does prototypal inheritance work?</h1>
                <div className='py-2  '>
            ...
            <div class=" bg-base-200 mt-5 text-left p-8 rounded-b-box">
                <div>
                <h1 class="text-2xl  font-bold">4. You have an array and product each object has a name, price, descriptsion etc, How will you implement a search to find product by name </h1>
                <div className='py-2  '>
            ...
            <div class=" bg-base-200 mt-5 text-left p-8 rounded-b-box">
                <div>
                <h1 class="text-2xl  font-bold">5. What is unit test? why should write unit test ?</h1>
                <div className='py-2  '>
